...
def favorite_book(title):
    print(f"This is my all time favorite book, it is called, {title}.")

favorite_book('The Beauty Queen of Jerusalem')
...
def describe_city(city,country ="unknown"):
    print(f"I am from {city}, the country is {country}.")

describe_city('Kansas','United States of America')
describe_city('Bigfoot','United States of America')
describe_city('Humpty Doo')
describe_city('Punkeydoodles')
...
import random
def random_number_game(n):
    i = random.randint(1, 100)
    if i == n:
        print("Success!")
    else:
        print (f"Fail! Your number: {n}, Random number: {i}")

random_number_game(88)
random_number_game(42)
random_number_game(18)
...
def make_shirt(size,text):
    print(f"This shirt is in a size {size} with the text {text}.")
make_shirt("Small","I'm with stupid")

def make_shirt(size = "Large",text = "I Love Python"):
    print(f"This shirt is in a size {size} with the text {text}.")

make_shirt() # Default (This shirt is in a size Large with the text I Love Python.
make_shirt('Medium')
make_shirt("Small","Got Milk?")
...
def show_magicians(magician_names):
    for m in magician_names: print(m) 
show_magicians(magician_names)

magician_names = ['Harry Houdini', 'David Blaine', 'Criss Angel']
def make_great(magician_names):
    for m in range(len(magician_names)):
        magician_names[m] = f"{magician_names[m]} the Great"
